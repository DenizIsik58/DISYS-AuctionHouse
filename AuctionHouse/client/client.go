...
var name string
var client auction.ChatServiceClient
...
func Publish(message string) {
	...
	_, err := client.Publish(ctx, &auction.Message{User: name, Content: message, Lamport: lamport})
...
func main() {
	...
	client = auction.NewChatServiceClient(conn)
